...
local boxes_settings = {
    -- Background
    {
        ...
        corners = {150, 150, 0, 0},  -- TL, TR, BR, BL
    ...
    {
        type = "background",
        x = 5, y = 170, w = 320, h = 155,
        centre_x = true,  -- Optioneel centreren
        corners = {0, 0, 140, 140},  -- TL, TR, BR, BL
        rotation = 0,  -- Toegevoegd voor rotatiemogelijkheid
        draw_me = true,
        colour = bg_color
    },
    ...
    -- Border
    {
        ...
        border = 8,
        colour = border_color,
        linear_gradient = {0, 78, 320, 75}  -- Aangepast aan x en w
    },
    {
        type = "border",
        x = 5, y = 170, w = 320, h = 156,
        centre_x = true,
        corners = {0, 0, 140, 140},  -- TL, TR, BR, BL
        rotation = 0,  -- Toegevoegd voor rotatiemogelijkheid
        draw_me = true,
        border = 8,
        colour = border_color,
        linear_gradient = {0, 244, 320, 244}  -- Aangepast aan x en w
    }
}
